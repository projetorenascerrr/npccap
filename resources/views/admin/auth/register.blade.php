...
<head>
    ...
    <title>Painel Administrativo - Registrar | NPCCAP</title>
    ...
    <div class="container py-5">
        <div class="auth-card rounded-4 p-4 p-lg-5 mx-auto" style="max-width: 460px;">
            <div class="text-center mb-4">
                ...
                <h1 class="h3 fw-semibold mb-1 text-white">Criar Conta Admin</h1>
                <p class="text-secondary small">Cadastre um novo administrador do sistema.</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.register.perform') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Seu nome"
                ...
                <button type="submit" class="btn btn-admin w-100 text-white py-2 fw-medium">Cadastrar Admin</button>
            </form>

            <div class="text-center mt-4 border-top border-secondary pt-3">
                <p class="small text-secondary mb-0">Já tem conta? <a href="{{ route('admin.login') }}" class="text-danger text-decoration-none fw-semibold">Entre aqui</a>.</p>
            </div>
        </div>
    </div>
</body>
