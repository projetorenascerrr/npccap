...
<head>
    ...
    <title>Redefinir Senha - Portal do Aluno | NPCCAP</title>
    ...
    <div class="container py-5">
        <div class="auth-card rounded-4 p-4 p-lg-5 mx-auto" style="max-width: 460px;">
            <div class="text-center mb-4">
                ...
                <span class="badge text-bg-success-subtle text-success border border-success-subtle mb-2 px-3 py-2">REDEFINIÇÃO DE SENHA</span>
                <h1 class="h3 fw-semibold mb-1">Redefinir Senha</h1>
                <p class="text-soft">Crie uma nova senha de acesso ao portal do aluno.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $email) }}" placeholder="seu.email@exemplo.com"
                ...
                <button type="submit" class="btn btn-student w-100 text-white py-2.5 fw-medium">Redefinir Senha</button>
            </form>
        </div>
    </div>
</body>
