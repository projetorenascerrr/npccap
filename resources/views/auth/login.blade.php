...
<body class="auth-page d-flex align-items-center">
    <div class="container py-5">
        <div class="auth-card rounded-4 p-4 p-lg-5 mx-auto" style="max-width: 460px;">
            ...
            <h1 class="h3 fw-semibold mb-3 text-center">Acesse a plataforma de inscrição</h1>
            <p class="text-soft text-center mb-4">Faça login para continuar e gerenciar inscrições.</p>
            ...
            <form method="POST" action="{{ route('login.perform') }}">
                ...
                <button type="submit" class="btn btn-brand w-100 text-white">Entrar</button>
            </form>

            <p class="text-center text-soft small mt-4">Não tem conta? <a href="{{ route('register') }}"
