        ...
        <div class="hero-card rounded-4 p-4 p-lg-5">
            ...
            <form method="POST" action="{{ route('courses.update', $course) }}" enctype="multipart/form-data"
                ...
                <div class="col-md-6">
                    ...
                    <input id="minimum_frequency" name="minimum_frequency" type="number" min="0" max="100" step="0.01"
                        class="form-control" value="{{ old('minimum_frequency', $course->minimum_frequency) }}">
                </div>
