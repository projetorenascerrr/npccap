...
<body>
    <div class="app-shell d-flex flex-column flex-lg-row min-vh-100">
        <aside class="app-sidebar offcanvas-lg offcanvas-start text-bg-dark" tabindex="-1" id="appSidebar" aria-labelledby="appSidebarLabel">
            <div class="offcanvas-header border-bottom border-secondary">
                <h5 class="offcanvas-title fw-bold" id="appSidebarLabel">Menu</h5>
                <button type="button" class="btn-close btn-close-white d-lg-none" data-bs-dismiss="offcanvas" aria-label="Fechar"></button>
            </div>
            <div class="offcanvas-body d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar-frame">
                ...
                <ul class="nav nav-pills flex-column mb-auto gap-2">
                    <li class="nav-item">
                        <a href="{{ route('certificates.index') }}" class="nav-link {{ request()->routeIs('certificates.*') ? 'active' : 'text-white' }}" aria-current="page">
